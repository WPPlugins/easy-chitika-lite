  ...
  class EasyChitika extends ezAdsPlugin {
    ...
    function pluginActionLinks($links, $file) {
      if ($file == plugin_basename(__FILE__)) {
        $settingsLink = "<a href='options-general.php?page=easy-chitika-lite'>Settings</a>";
        array_unshift($links, $settingsLink);
        $buyLink = "<a href='http://buy.thulasidas.com/easy-chitika' class='popup' target='_top'><b style='color:red'>Go <i>Pro</i>!</b></a>";
...
if (class_exists("easyChitika")) {
  ...
  if (isset($mChitika)) {
    ...
    add_filter('plugin_action_links', array($mChitika, 'pluginActionLinks'), -10, 2);
  }
}
else {
